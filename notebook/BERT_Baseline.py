...
#get_ipython().system('conda install -c huggingface transformers')
...
tokenizer = BertTokenizer.from_pretrained('bert-base-multilingual-cased', cache_dir='transformers/bert_ckpt', do_lower_case=False)
...
cls_model = TFBertClassifier(model_name='bert-base-multilingual-cased',
                             dir_path='transformers/bert_ckpt',
                             num_class=46)
